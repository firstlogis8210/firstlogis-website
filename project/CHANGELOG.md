...
- [ADD] `/bike` 하단에 메인 홈페이지의 로고, 대표번호, 사업자 정보 및 법적 약관 링크를 재사용한 푸터 추가
- [KEEP] 바이크 본문 디자인, 전화 중심 CTA 및 기존 analytics 추적 코드 무변경

## TEST

- [DONE] 푸터 사업자 정보·상대 링크·PC 및 모바일 반응형 스타일 정적 검증
